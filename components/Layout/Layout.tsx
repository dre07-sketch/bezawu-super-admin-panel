          ...
          <div className="flex items-center space-x-6">
            ...
            <div className={`flex items-center space-x-4 border-l pl-8 border-[var(--border-color)]`}>
              <div className="text-right">
                <p className={`text-xs font-bold uppercase tracking-widest text-[var(--text-primary)]`}>Admin 001</p>
                <p className={`text-[9px] font-black uppercase tracking-[0.2em] text-[var(--accent)] opacity-50`}>Verified</p>
              </div>
              <div className={`w-12 h-12 rounded-2xl glass-card border-[var(--border-color)] flex items-center justify-center relative overflow-hidden`}>
                <img src="https://api.dicebear.com/7.x/identicon/svg?seed=Admin" alt="Avatar" className={`w-8 h-8 relative z-10 opacity-40`} />
              </div>
            </div>
          </div>
        </header>
